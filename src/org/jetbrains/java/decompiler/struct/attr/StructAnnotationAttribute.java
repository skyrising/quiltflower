...
public class StructAnnotationAttribute extends StructGeneralAttribute {
  ...
  public static Exprent parseAnnotationElement(DataInputStream data, ConstantPool pool) throws IOException {
    ...
    switch (tag) {
      ...
      default:
        ...
        return getConstExprent(tag, cn);
    }
  }

  private static String getStringForType(VarType type) {
    switch (type.type) {
  ...
  private static ConstExprent getConstExprent(int tag, PrimitiveConstant cn) {
    switch (tag) {
      case 'B':
